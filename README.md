# react-native-vlcplayer-wesmart
...
[VLC Media Player test](https://github.com/razorRun/react-native-vlcplayer-wesmart-test)
...
`npm i react-native-vlcplayer-wesmart --save`

Run `react-native link react-native-vlcplayer-wesmart`
...
1. Get a fork of tis repo and clone [VLC Media Player test](https://github.com/vinhnq90/react-native-vlcplayer-wesmart-test) 
2. Run it for ios and android locally using your fork, and do the changes. (remove this package using ```npm remove react-native-vlcplayer-wesmart``` and install the forked version from git hub ```npm i https://git-address-to-your-forked-repo```)  
...
```
  (1) import { VLCPlayer, VlCPlayerView } from 'react-native-vlcplayer-wesmart';
